...
const NewFeatures = ({ onHelpPages }) => {
  ...
  return (
    <section className="about-section">
      <h1 className="about-section-titre">Fonctionnalités à venir</h1>
      <div className="about-section-text">
        <h2 className="about-section-text-title">De nouvelles fontionnalités captivantes sont dans les tuyaux ! </h2>
